...
const App = () => {
  ...
  const updateDoneData = (ID: string) => {
    const url: string = `http://localhost:4499/api/done/${ID}`;
  ...
  const updateProgressData = (ID: string) => {
    const url: string = `http://localhost:4499/api/progress/${ID}`;
